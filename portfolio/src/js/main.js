...
import { listaProyectos } from './datos/createJSON'
...
filtrarProyectos = () => {
  ...
  listaProyectos.forEach(proyecto => {
    if (proyecto.categoria.includes('programacion') && seleccion === 'programacion') {
      // datos
      ...
      cards.forEach((card, indice) => {
         //TODO crear una funcion para pasar las imagenes e insertar en vez de proyecto.imagen[indice]
        card.style.cssText = `bacground-image: url("../imagenes/${proyecto.nombre}/${proyecto.imagenes[indice]}") no-repeat cover;`  
      });
    }
  });
